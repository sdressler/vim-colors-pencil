# vim-colors-pencil-and-code

> A light color scheme for NeoVim inspired by reedes/vim-colors-pencil

## Features

This is a fork of the original vim-colors-pencil by reedes and adds some
improvements which are mostly focused on syntax.

### Original color scheme features
...
* 2020-08-27: Basic Python syntax highlighting

## Requirements

* Currently requires vim >= 7.0
* I use vim-polyglot for syntax highlighting

## Installation

Plug it into your config:

```vim
Plug 'sdressler/vim-colors-pencil-and-code'
colorscheme pencil
```
